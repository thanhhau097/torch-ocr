...
def create_strings_from_wikipedia(minimum_length, count, lang, maximum_length=50):
    """
    ...
    while len(sentences) < count:
        ...
        path = "https://{}.wikipedia.org/wiki/Special:Random".format(lang)
        print("requesting new page:", path)
